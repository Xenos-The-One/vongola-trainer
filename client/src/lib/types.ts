...
export interface Store {
  ...
  /**
   * Plans the user has explicitly saved to reuse. Independent of weeklyPlan
   * (which gets overwritten on each Generate) — these survive regeneration
   * and can be loaded back as the active plan from the Generate sheet.
   */
...
/** A user-named weekly plan they explicitly chose to keep. */
